...
class Ui_pesquisalivros(object):
    def setupUi(self, pesquisalivros):
        ...
        self.tblBuscalivros.setGeometry(QtCore.QRect(0, 140, 411, 201))
        ...
        self.edtlivro.setGeometry(QtCore.QRect(70, 60, 121, 20))
        ...
        self.edtautor.setGeometry(QtCore.QRect(200, 60, 101, 20))
        ...
        self.BtnBuscarLivros.setGeometry(QtCore.QRect(320, 60, 75, 23))
        ...
        self.lblCod = QtWidgets.QLabel(self.centralwidget)
        self.lblCod.setGeometry(QtCore.QRect(10, 40, 47, 13))
        self.lblCod.setObjectName("lblCod")
        self.lblLivro = QtWidgets.QLabel(self.centralwidget)
        self.lblLivro.setGeometry(QtCore.QRect(70, 40, 47, 13))
        self.lblLivro.setObjectName("lblLivro")
        self.lblAutor = QtWidgets.QLabel(self.centralwidget)
        self.lblAutor.setGeometry(QtCore.QRect(200, 40, 31, 16))
    ...
    def retranslateUi(self, pesquisalivros):
        ...
        self.lblCod.setText(_translate("pesquisalivros", "Código"))
        self.lblLivro.setText(_translate("pesquisalivros", "Livro"))
        self.lblAutor.setText(_translate("pesquisalivros", "Autor"))
